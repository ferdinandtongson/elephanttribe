...
public class BoomUtil {
    ...
    static Activity scanForActivity(Context context) {
        if (context == null) {
            Log.w("Choice", "BoomUtil.scanForActivity: context is null!");
            return null;
    ...
    public static int getColor(
            ...
            int id,
            int defaultId) {
        return typedArray.getColor(id, BoomUtil.getColor(typedArray, defaultId));
    }
    ...
    private static BoomUtil ourInstance = new BoomUtil();

    public static BoomUtil getInstance() {
        return ourInstance;
    }
