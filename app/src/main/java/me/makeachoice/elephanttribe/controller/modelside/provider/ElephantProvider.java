...
import static me.makeachoice.elephanttribe.controller.modelside.provider.UriMatcherHelper.DECK_TAG_WITH_TAG;
import static me.makeachoice.elephanttribe.controller.modelside.provider.UriMatcherHelper.DECK_TAG_WITH_USERID;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] args, String order){
        ...
        switch(dbUriMatcher.match(uri)){
            ...
            case DECK_WITH_STATUS:
                ...
                break;
            case DECK_TAG_WITH_USERID:
                cursor = DeckTagQuery.getByUserId(mDBHelper, uri, projection, order);
                break;
            case DECK_TAG_WITH_DECKID:
                cursor = DeckTagQuery.getByDeckId(mDBHelper, uri, projection, order);
                break;
            case DECK_TAG_WITH_TAG:
                cursor = DeckTagQuery.getByTag(mDBHelper, uri, projection, order);
                break;
